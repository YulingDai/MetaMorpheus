...
namespace TaskLayer
{
    public class SearchTask : MetaMorpheusTask
    {
        ...
        protected override MyTaskResults RunSpecific(string OutputFolder, List<DbForTask> dbFilenameList, List<string> currentRawFileList, string taskId, FileSpecificParameters[] fileSettingsList, Spectrum[] spectralLibrary)
        {
            ...
            //string experimentalSpectrums = Path.Combine(this.OutputFolder, @"TestData\spectralLibrary.msp");
            ...
            //var search = new ClassicSearchOfSpectralLibrary(spectralLibrary, experimentalProcessedSpectrums, 0.05, 0.02, 5);
        ...
        protected override MyTaskResults RunSpecific(string OutputFolder, List<DbForTask> dbFilenameList, List<string> currentRawFileList, string taskId, FileSpecificParameters[] fileSettingsList)
        {
            ...
            //string experimentalSpectrums = Path.Combine(this.OutputFolder, @"SpectralLibrary");
            //spectralLibraryReader experimentalSpectrumsReader = new spectralLibraryReader(experimentalSpectrums);
            //Spectrum[] experimentalProcessedSpectrums = experimentalSpectrumsReader.spectrums;
            //var search = new ClassicSearchOfSpectralLibrary(spectralLibrary, experimentalProcessedSpectrums, 0.05, 0.02, 5);
