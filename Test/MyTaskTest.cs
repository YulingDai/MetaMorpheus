    ...
    public static class MyTaskTest
    {
        ...
        public static void TestFileOutput()
        {
            ...
            HashSet<string> expectedFiles = new HashSet<string> {
                ...
                "AllQuantifiedPeptides.tsv", "prose.txt", "results.txt", "sliced-raw.mzID", "spectralLibrary.msp"};
            ...
            expectedFiles = new HashSet<string> {
                "AllPeptides.psmtsv", "AllProteinGroups.tsv", "AllPSMs.psmtsv", "AllPSMs_FormattedForPercolator.tab", "AllQuantifiedPeaks.tsv",
                "AllQuantifiedPeptides.tsv", "prose.txt", "results.txt", "spectralLibrary.msp"};
